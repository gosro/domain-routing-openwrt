...
```
sh <(wget -O - https://raw.githubusercontent.com/gosro/domain-routing-openwrt/master/getdomains-install.sh)
```

# Скрипт для удаления
```
sh <(wget -O - https://raw.githubusercontent.com/gosro/domain-routing-openwrt/refs/heads/master/getdomains-uninstall.sh)
```
